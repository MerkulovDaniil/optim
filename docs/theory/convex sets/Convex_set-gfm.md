...
The set $S$ is called **convex** if for any $x_1, x_2$ from $S$ the line
...
Figure 2: Top: examples of convex sets. Bottom: examples of non-convex
sets.
...
The Minkowski sum of two sets of vectors $S_1$ and $S_2$ in Euclidean
